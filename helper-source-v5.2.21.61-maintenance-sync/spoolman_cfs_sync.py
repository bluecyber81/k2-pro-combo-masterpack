...
v5.2.21.61-maintenance-sync keeps the interactive map wizard, map
...
BUILD_LABEL = "5.2.21.61-maintenance-sync"
...
def run_wizard() -> None:
    ...
    mapping = {
        "enabled": True,
        "_generated_by": "k2pro-helper-v5.2.21.61-maintenance-sync",
