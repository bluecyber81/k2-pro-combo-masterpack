...
v5.2.21.86-status-dedicated keeps the interactive map wizard, map
...
BUILD_LABEL = "5.2.21.86-status-dedicated"
...
def run_wizard() -> None:
    ...
    mapping = {
        "enabled": True,
        "_generated_by": "k2pro-helper-v5.2.21.86-status-dedicated",
