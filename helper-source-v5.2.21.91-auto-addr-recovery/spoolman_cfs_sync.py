...
v5.2.21.91-auto-addr-recovery keeps the interactive map wizard, map
...
BUILD_LABEL = "5.2.21.91-auto-addr-recovery"
...
def run_wizard() -> None:
    ...
    mapping = {
        "enabled": True,
        "_generated_by": "k2pro-helper-v5.2.21.91-auto-addr-recovery",
