...
def display_color(value):
    value = str(value or "")
    # Creality stores CFS colors as #0RRGGBB. Show the familiar six-digit
    # RGB value without changing the live database representation.
