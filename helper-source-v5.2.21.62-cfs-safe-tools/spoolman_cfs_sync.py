...
v5.2.21.62-cfs-safe-tools keeps the interactive map wizard, map
...
BUILD_LABEL = "5.2.21.62-cfs-safe-tools"
...
def run_wizard() -> None:
    ...
    mapping = {
        "enabled": True,
        "_generated_by": "k2pro-helper-v5.2.21.62-cfs-safe-tools",
